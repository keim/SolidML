        ...
        "float getShadow( sampler2D shadowMap, vec2 shadowMapSize, float shadowBias, float shadowRadius, vec4 shadowCoord ) {",
          ...
          "if (all(bvec2(inFrustum, shadowCoord.z <= 1.0))) {",
            "#if defined( SHADOWMAP_TYPE_PCF ) || defined( SHADOWMAP_TYPE_PCF_SOFT )",
              ...
              "vec4 d = vec4(-texelSize, texelSize)*shadowRadius;",
              "shadow = (",
                "texture2DCompare( shadowMap, shadowCoord.xy + d.xy, shadowCoord.z ) +",
                "texture2DCompare( shadowMap, shadowCoord.xy + d.zy, shadowCoord.z ) +",
                "texture2DCompare( shadowMap, shadowCoord.xy, shadowCoord.z ) +",
                "texture2DCompare( shadowMap, shadowCoord.xy + d.xw, shadowCoord.z ) +",
                "texture2DCompare( shadowMap, shadowCoord.xy + d.zw, shadowCoord.z )",
              ") * ( 1.0 / 5.0 );",
